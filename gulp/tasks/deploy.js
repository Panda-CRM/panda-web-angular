 ...
 gulp.task('deploy', function(cb) {
     ...
     request
         ...
         .send("client_id=" + config.OAuth.client_id + "&client_secret=" + config.OAuth.client_secret + "&code=" + config.OAuth.refresh_token + "&grant_type=authorization_code&redirect_uri=urn:ietf:wg:oauth:2.0:oob")
